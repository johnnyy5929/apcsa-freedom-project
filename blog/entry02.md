...
## context
For this year-long project, I decided to use the tool Godot. Godot is a game engine where you can make 2D or 3D games. My backup tool was Swift, which is another tool for making games on the App Store. After doing my learning logs, I decided to stay with Godot as my tool. For Godot, I was planning on making a racing game and working with Bryan. We just wanted to have fun in our senior year and enjoy life, so we are making a fun game that people can enjoy. So we started talking about what we should do during break and decided that we both will learn more code, do more on Godot, and start making models of the cars that we will be adding. 
...
![](../tool/Screenshot_2-11-2025_101933_docs.google.com.jpeg)
